    ...
    return (
      <div>
        ...
        <Mutation
          ...
          update={(cache, { data: { createWizard } }) => {
            const Wizards = cache.readQuery({ query: WIZARD_QUERY });
            Wizards.Wizards.push(createWizard);
            cache.writeQuery({
              query: WIZARD_QUERY,
              data: Wizards
            });
